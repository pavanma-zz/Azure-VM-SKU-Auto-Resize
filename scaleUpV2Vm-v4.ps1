...
.PARAMETER ResourceGroupName 
   Optional  
   The resource group that the VM is in.  Set this parameter when you do not start the runbook from a VM alert. 
...
{   
    ...
    $scaleUp = @{ 
        ...
        "Standard_DS12_v2" = "Standard_D13_v2"
    ...
    $scaleUp_Memory = @{ 
        ...
        "Standard_DS4_v2"  = "Standard_DS5_v2"
        "Standard_DS5_v2"  = $noResize
        "Standard_D11_v2"  = "Standard_D3_v2" # DS3_v2 and DS11_v2 are pairs (both 14GB, cores 4 and 2 respectively)
        "Standard_D12_v2"  = "Standard_D4_v2"  # DS4_v2 and DS12_v2 are pairs (both 28GB, cores 8 and 4 respectively)
        "Standard_D13_v2"  = "Standard_D5_v2"   # DS5_v2 and DS12_v2 are pairs (both 28GB, cores 8 and 4 respectively) 
        ...
        "Standard_DS3"     = "Standard_DS4"
        "Standard_DS4"     = $noResize
        "Standard_DS11"    = "Standard_DS3"  # DS3 and DS11 are pairs (both 14GB, cores 4 and 2 respectively)
        "Standard_DS12"    = "Standard_DS4"   # DS4 and DS12 are pairs (both 28GB, cores 8 and 4 respectively)
        "Standard_DS13"    = "Standard_DS14" 
        "Standard_DS14"    = $noResize
        "Standard_DS11_v2" = "Standard_DS3_v2" # DS3_v2 and DS11_v2 are pairs (both 14GB, cores 4 and 2 respectively)
        "Standard_DS12_v2" = "Standard_DS4_v2" # DS4_v2 and DS12_v2 are pairs (both 14GB, cores 4 and 2 respectively)
        "Standard_DS13_v2" = "Standard_DS5_v2" # DS5_v2 and DS13_v2 are pairs (both 14GB, cores 4 and 2 respectively)
        "Standard_DS14_v2" = "Standard_DS15_v2"
        "Standard_DS15_v2" = $noResize
        "Standard_D1"      = "Standard_D2" 
        "Standard_D2"      = "Standard_D3" 
        "Standard_D3"      = "Standard_D4"
        "Standard_D4"      =  $noResize
        "Standard_D11"     = "Standard_D3"    # DS3 and DS11 are pairs (both 14GB, cores 4 and 2 respectively) 
        "Standard_D12"     = "Standard_D4"   # DS4 and DS12 are pairs (both 28GB, cores 8 and 4 respectively) 
        "Standard_D13"     = "Standard_D14" 
        "Standard_D14"     = $noResize 
        "Standard_G1"      = "Standard_G2"  
        "Standard_G2"      = "Standard_G3" 
    ...
    if ($MonitorMemory -eq 'Yes') {
        ...
        $newVMSize = $scaleUp_Memory[$currentVMSize]
    } else {
